...
import { Accordion, AccordionDetails, AccordionSummary, Button, FormControlLabel, IconButton, MenuItem, Radio, Select, Switch, Typography } from "@mui/material";
import { ArrowRight, CheckBox, Close, CropOriginal, ShortText, Subject, FilterNone, MoreVert, DeleteOutline, AddCircleOutline, OndemandVideo, TextFields } from "@mui/icons-material";
        ...
        <div className="question_boxes">
          <AccordionDetails className="add_question">
            <div className="add_question_top">
              <input type="text" className="question" placeholder="Question" value={ques.questionText} onChange={(event)=> {changeQuestion(event.target.value, i)}} />
            ...
            {ques.options.map((op, j) => (
              <div className="add_question_body" key={j}>
                ...
                <div>
                  <input type="text" className="text_input" placeholder="option" value={ques.options[j].optionText} onChange={(event)=> {changeOptionValue(event.target.value, i, j)}} />
                </div>
            ...
            <div className="add_footer">
              ...
              <div className="add_question_bottom_left">
                <Button size="small" style={{textTransform: 'none', color:"#4285f4", fontSize:'13px', fontWeight:'600'}}>
                  Answer key<ArrowRight style={{padding:"2px", marginRight:"8px"}} />
                </Button>
              </div>
